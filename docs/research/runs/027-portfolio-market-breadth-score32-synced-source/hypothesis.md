# 027-portfolio-market-breadth-score32-synced-source 组合回测假设

- 时间：2026-05-30 04:25 +0800
- 策略：MA趋势跟随-高弹性止盈-移除MACD过滤 (`trend-follow-maximum-profit-no-macd`)
- 前置证据：`026-single-tail-market-breadth-score32`：targetMet=False，tailRiskMet=False

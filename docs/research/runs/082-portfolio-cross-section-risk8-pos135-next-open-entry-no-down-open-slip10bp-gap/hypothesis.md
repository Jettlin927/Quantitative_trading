# 082-portfolio-cross-section-risk8-pos135-next-open-entry-no-down-open-slip10bp-gap 组合回测假设

- 时间：2026-05-30 21:37 +0800
...
- 成本压力：1.0x。
- 成交压力：买入滑点 0.10%，卖出滑点 0.10%，跳空止损开盘成交 是，涨停附近买入阈值 n/a，次日开盘执行 是。

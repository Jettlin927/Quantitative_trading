# 041-portfolio-risk-on-trend-liquid-tight-stop 组合回测假设

- 时间：2026-05-30 04:41 +0800
- 策略：MA趋势跟随-高弹性止盈-紧止损 (`trend-follow-tight-stop-maximum-profit`)
- 前置证据：`039-single-tail-risk-on-trend-liquid-tight-stop`：targetMet=False，tailRiskMet=False

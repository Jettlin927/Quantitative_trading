# 090-portfolio-cross-section-risk8-pos135-overnight-budget20-slip10bp-gap 组合回测假设

- 时间：2026-05-30 23:17 +0800
...
- 组合参数：最大持仓 3，单票建仓上限 13.5%，单票观测暴露上限 15.0%，行业上限 40.0%，隔夜持仓预算 20.00%，每周最多新开仓 2。
- 买入排序：cross_section_strength。
- 活跃标的上限：None，老标的加分 0.0。
- 信号阈值：min=None，max=None。
- 成本压力：1.0x。
- 成交压力：买入滑点 0.10%，卖出滑点 0.10%，跳空止损开盘成交 是，涨停附近买入阈值 n/a，次日开盘执行 否，早期退出 0日/n/a/破开仓低点 否，跳空冷却 全市场0日/行业0日/标的0日，行业隔夜风险 0日/3.00%/count>=0/ratio>=0.00%。
